    ...
    <div className={"w-full pt-44 pb-16 flex justify-center items-center flex-col xl:flex-row"}>
      ...
      >
        <div className={"bg-cardBG flex flex-col items-center py-8 px-4 xl:py-16"}>
          ...
          <h4 className="uppercase font-light tracking-wider text-lg md:text-lg 3xl:text-2xl text-center">
            {position}
          </h4>
        </div>
      ...
      <div className={"w-[70%] flex flex-col py-6 xl:mr-7 xl:w-[45%] 2xl:w-1/3 3xl:w-1/4"}>
        ...
        <TextH3 className={"mt-2 text-2xl text-end xl:text-start"}>{subtitle}</TextH3>
        <div className={"flex flex-col items-end justify-end xs:flex-row xl:justify-start"}>
          ...
          <ButtonLink url={"/projects"} title={"Projects"} isTransparent={true} className={"mr-0"} />
        </div>
        <p className={"text-xl font-extralight text-buttons text-end xl:text-start 2xl:text-2xl 3xl:text-3xl"}>
          {description}
        </p>
      </div>
    </div>
